...
- Current Packwiz release `1.9.0-rc4`
...
RC4 remains an in-place Packwiz update. Existing controls, video settings, resource-pack order, shader choice and settings, screenshots, saves, maps and other personal player data stay preserved.
