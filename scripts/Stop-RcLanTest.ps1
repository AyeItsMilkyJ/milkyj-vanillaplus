...
$questsLoaded = (Test-Path -LiteralPath $latest) -and [bool](Select-String -LiteralPath $latest -Pattern 'Loaded 4 chapter groups, 9 chapters, 118 quests, 0 reward tables' -Quiet)
$stopped = [ordered]@{
