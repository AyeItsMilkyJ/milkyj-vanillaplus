...
The latest authoritative runs through 15 August 2026 established:

- 235 clean client JARs and 203 clean server JARs;
- 709 Packwiz destinations and 237 mod definitions;
...
The seven proven isolated override resources should be included in 1.9.0. The casket lookup correction was tested in the same disposable client world used for the shader/resource repair pass; the original warning disappeared and no new datapack, loot-table or advancement error appeared.
